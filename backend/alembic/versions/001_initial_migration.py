...
def upgrade() -> None:
    ...
    op.create_index('idx_chunk_timestamps', 'chunks', ['start_timestamp', 'end_timestamp'], unique=False)
    op.create_index('idx_chunk_user_video', 'chunks', ['user_id', 'video_id'], unique=False)
    op.create_index('idx_chunk_video_index', 'chunks', ['video_id', 'chunk_index'], unique=False)
    ...
    op.create_table('conversations',
        ...
        sa.Column('selected_video_ids', postgresql.ARRAY(postgresql.UUID(as_uuid=True)), nullable=False),
    ...
    op.create_table('message_chunk_references',
        sa.Column('id', postgresql.UUID(as_uuid=True), nullable=False),
    ...
    op.create_index(op.f('ix_message_chunk_references_chunk_id'), 'message_chunk_references', ['chunk_id'], unique=False)
    op.create_index(op.f('ix_message_chunk_references_message_id'), 'message_chunk_references', ['message_id'], unique=False)
    ...
    op.create_table('usage_events',
        ...
        sa.Column('quota_amount_used', sa.Numeric(precision=10, scale=2), nullable=True),
        sa.Column('event_timestamp', sa.DateTime(), nullable=False),
        sa.ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_usage_events_event_timestamp'), 'usage_events', ['event_timestamp'], unique=False)
    ...
    op.create_table('user_quotas',
        ...
        sa.Column('storage_mb_limit', sa.Numeric(precision=10, scale=2), nullable=False),
